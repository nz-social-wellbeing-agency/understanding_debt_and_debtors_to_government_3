...
Outputs:
- [IDI_UserCode].[DL-MAA2020-01].[defn_alive]
...
/* Clear existing view */
IF OBJECT_ID('[DL-MAA2020-01].[defn_alive]','V') IS NOT NULL
DROP VIEW [DL-MAA2020-01].[defn_alive];
GO

/* Create view */
CREATE VIEW [DL-MAA2020-01].[defn_alive] AS
SELECT *
FROM (
	SELECT snz_uid
