...
Outputs:
- [IDI_Sandpit].[DL-MAA2020-01].[defn_abt_main_benefit_final]
...
DROP VIEW IF EXISTS [DL-MAA2020-01].[tmp_main_benefit_spell_input];
GO
DROP VIEW IF EXISTS [DL-MAA2020-01].[tmp_main_benefit_partner_input];
GO
...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA2020-01].[tmp_main_benefit_spell_condensed];
GO
...
CREATE NONCLUSTERED INDEX my_index ON [IDI_Sandpit].[DL-MAA2020-01].[tmp_main_benefit_spell_condensed] ([snz_uid])
...
/* drop table before re-creating */
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA2020-01].[tmp_main_benefit_partner_condensed];
GO
...
CREATE NONCLUSTERED INDEX my_index ON [IDI_Sandpit].[DL-MAA2020-01].[tmp_main_benefit_partner_condensed] ([snz_uid])
...
/* drop table before re-creating */
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA2020-01].[tmp_main_benefit_spell_invert];
GO
...
CREATE NONCLUSTERED INDEX my_index ON [IDI_Sandpit].[DL-MAA2020-01].[tmp_main_benefit_spell_invert] ([snz_uid])
...
/* drop table before re-creating */
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA2020-01].[tmp_main_benefit_partner_invert];
GO
...
CREATE NONCLUSTERED INDEX my_index ON [IDI_Sandpit].[DL-MAA2020-01].[tmp_main_benefit_partner_invert] ([snz_uid])
...
/* drop table before re-creating */
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA2020-01].[defn_abt_main_benefit_final];
GO
...
SELECT k.*
	...
	,code.level3
	,code.level4
INTO [IDI_Sandpit].[DL-MAA2020-01].[defn_abt_main_benefit_final]
FROM (
...
CREATE NONCLUSTERED INDEX my_index ON [IDI_Sandpit].[DL-MAA2020-01].[defn_abt_main_benefit_final] ([snz_uid])

ALTER TABLE [IDI_Sandpit].[DL-MAA2020-01].[defn_abt_main_benefit_final] REBUILD PARTITION = ALL WITH (DATA_COMPRESSION = PAGE)
