...
INTERIM_TABLE_5 ="[d2gP3_tidy_table_interim_5]"
...
working_table = working_table %>%
  # MSD Debtors ------------------------------------------------------------------------------
  mutate(
    msd_12_debtor = ifelse(((coalesce(msd_balance_2012,0) > MIN_CHECK) || 
                              (coalesce(msd_balance_2012,0) > MIN_CHECK & coalesce(msd_repaid_2012,0) > MIN_CHECK) ||
                              (coalesce(msd_balance_2012,0) > MIN_CHECK & coalesce(msd_principle_2012,0) > MIN_CHECK)), 1, 0),
    
    msd_13_debtor = ifelse(((coalesce(msd_balance_2013,0) > MIN_CHECK) || 
                              (coalesce(msd_balance_2013,0) > MIN_CHECK & coalesce(msd_repaid_2013,0) > MIN_CHECK) ||
                              (coalesce(msd_balance_2013,0) > MIN_CHECK & coalesce(msd_principle_2013,0) > MIN_CHECK)), 1, 0),
    
    msd_14_debtor = ifelse(((coalesce(msd_balance_2014,0) > MIN_CHECK) || 
                              (coalesce(msd_balance_2014,0) > MIN_CHECK & coalesce(msd_repaid_2014,0) > MIN_CHECK) ||
                              (coalesce(msd_balance_2014,0) > MIN_CHECK & coalesce(msd_principle_2014,0) > MIN_CHECK)), 1, 0),
    
    msd_15_debtor = ifelse(((coalesce(msd_balance_2015,0) > MIN_CHECK) || 
                              (coalesce(msd_balance_2015,0) > MIN_CHECK & coalesce(msd_repaid_2015,0) > MIN_CHECK) ||
                              (coalesce(msd_balance_2015,0) > MIN_CHECK & coalesce(msd_principle_2015,0) > MIN_CHECK)), 1, 0),
    
    msd_16_debtor = ifelse(((coalesce(msd_balance_2016,0) > MIN_CHECK) || 
                              (coalesce(msd_balance_2016,0) > MIN_CHECK & coalesce(msd_repaid_2016,0) > MIN_CHECK) ||
                              (coalesce(msd_balance_2016,0) > MIN_CHECK & coalesce(msd_principle_2016,0) > MIN_CHECK)), 1, 0),
    
    msd_17_debtor = ifelse(((coalesce(msd_balance_2017,0) > MIN_CHECK) ||
                              (coalesce(msd_balance_2017,0) > MIN_CHECK & coalesce(msd_repaid_2017,0) > MIN_CHECK) ||
                              (coalesce(msd_balance_2017,0) > MIN_CHECK & coalesce(msd_principle_2017,0) > MIN_CHECK)), 1, 0),
    
    msd_18_debtor = ifelse(((coalesce(msd_balance_2018,0) > MIN_CHECK) || 
                              (coalesce(msd_balance_2018,0) > MIN_CHECK & coalesce(msd_repaid_2018,0) > MIN_CHECK) ||
                              (coalesce(msd_balance_2018,0) > MIN_CHECK & coalesce(msd_principle_2018,0) > MIN_CHECK)), 1, 0),
    
    msd_19_debtor = ifelse(((coalesce(msd_balance_2019,0) > MIN_CHECK) || 
                              (coalesce(msd_balance_2019,0) > MIN_CHECK & coalesce(msd_repaid_2019,0) > MIN_CHECK) ||
                              (coalesce(msd_balance_2019,0) > MIN_CHECK & coalesce(msd_principle_2019,0) > MIN_CHECK)), 1, 0),
    
    msd_20_debtor = ifelse(((coalesce(msd_balance_2020,0) > MIN_CHECK) || 
                              (coalesce(msd_balance_2020,0) > MIN_CHECK & coalesce(msd_repaid_2020,0) > MIN_CHECK) ||
                              (coalesce(msd_balance_2020,0) > MIN_CHECK & coalesce(msd_principle_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
  # MOJ Fine Debtors -------------------------------------------------------------------------
  mutate(
    moj_fine_12_debtor = ifelse(((coalesce(moj_fine_balance_2012,0) > MIN_CHECK) || 
                                   (coalesce(moj_fine_balance_2012,0) > MIN_CHECK & coalesce(moj_fine_repaid_2012,0) > MIN_CHECK) ||
                                   (coalesce(moj_fine_balance_2012,0) > MIN_CHECK & coalesce(moj_fine_principle_2012,0) > MIN_CHECK)), 1, 0),
    moj_fine_13_debtor = ifelse(((coalesce(moj_fine_balance_2013,0) > MIN_CHECK) || 
                                   (coalesce(moj_fine_balance_2013,0) > MIN_CHECK & coalesce(moj_fine_repaid_2013,0) > MIN_CHECK) ||
                                   (coalesce(moj_fine_balance_2013,0) > MIN_CHECK & coalesce(moj_fine_principle_2013,0) > MIN_CHECK)), 1, 0),
    moj_fine_14_debtor = ifelse(((coalesce(moj_fine_balance_2014,0) > MIN_CHECK) || 
                                   (coalesce(moj_fine_balance_2014,0) > MIN_CHECK & coalesce(moj_fine_repaid_2014,0) > MIN_CHECK) ||
                                   (coalesce(moj_fine_balance_2014,0) > MIN_CHECK & coalesce(moj_fine_principle_2014,0) > MIN_CHECK)), 1, 0),
    moj_fine_15_debtor = ifelse(((coalesce(moj_fine_balance_2015,0) > MIN_CHECK) || 
                                   (coalesce(moj_fine_balance_2015,0) > MIN_CHECK & coalesce(moj_fine_repaid_2015,0) > MIN_CHECK) ||
                                   (coalesce(moj_fine_balance_2015,0) > MIN_CHECK & coalesce(moj_fine_principle_2015,0) > MIN_CHECK)), 1, 0),
    moj_fine_16_debtor = ifelse(((coalesce(moj_fine_balance_2016,0) > MIN_CHECK) || 
                                   (coalesce(moj_fine_balance_2016,0) > MIN_CHECK & coalesce(moj_fine_repaid_2016,0) > MIN_CHECK) ||
                                   (coalesce(moj_fine_balance_2016,0) > MIN_CHECK & coalesce(moj_fine_principle_2016,0) > MIN_CHECK)), 1, 0),
    moj_fine_17_debtor = ifelse(((coalesce(moj_fine_balance_2017,0) > MIN_CHECK) || 
                                   (coalesce(moj_fine_balance_2017,0) > MIN_CHECK & coalesce(moj_fine_repaid_2017,0) > MIN_CHECK) ||
                                   (coalesce(moj_fine_balance_2017,0) > MIN_CHECK & coalesce(moj_fine_principle_2017,0) > MIN_CHECK)), 1, 0),
    moj_fine_18_debtor = ifelse(((coalesce(moj_fine_balance_2018,0) > MIN_CHECK) || 
                                   (coalesce(moj_fine_balance_2018,0) > MIN_CHECK & coalesce(moj_fine_repaid_2018,0) > MIN_CHECK) ||
                                   (coalesce(moj_fine_balance_2018,0) > MIN_CHECK & coalesce(moj_fine_principle_2018,0) > MIN_CHECK)), 1, 0),
    moj_fine_19_debtor = ifelse(((coalesce(moj_fine_balance_2019,0) > MIN_CHECK) || 
                                   (coalesce(moj_fine_balance_2019,0) > MIN_CHECK & coalesce(moj_fine_repaid_2019,0) > MIN_CHECK) ||
                                   (coalesce(moj_fine_balance_2019,0) > MIN_CHECK & coalesce(moj_fine_principle_2019,0) > MIN_CHECK)), 1, 0),
    moj_fine_20_debtor = ifelse(((coalesce(moj_fine_balance_2020,0) > MIN_CHECK) || 
                                   (coalesce(moj_fine_balance_2020,0) > MIN_CHECK & coalesce(moj_fine_repaid_2020,0) > MIN_CHECK) ||
                                   (coalesce(moj_fine_balance_2020,0) > MIN_CHECK & coalesce(moj_fine_principle_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
    
  # MOJ FCCO Debtors -------------------------------------------------------------------------
  mutate(
    moj_fcco_14_debtor = ifelse(((coalesce(moj_fcco_balance_2014,0) > MIN_CHECK) || 
                                   (coalesce(moj_fcco_balance_2014,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2014,0) > MIN_CHECK) ||
                                   (coalesce(moj_fcco_balance_2014,0) > MIN_CHECK & coalesce(moj_fcco_principle_2014,0) > MIN_CHECK)), 1, 0),
    moj_fcco_15_debtor = ifelse(((coalesce(moj_fcco_balance_2015,0) > MIN_CHECK) || 
                                   (coalesce(moj_fcco_balance_2015,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2015,0) > MIN_CHECK) ||
                                   (coalesce(moj_fcco_balance_2015,0) > MIN_CHECK & coalesce(moj_fcco_principle_2015,0) > MIN_CHECK)), 1, 0),
    moj_fcco_16_debtor = ifelse(((coalesce(moj_fcco_balance_2016,0) > MIN_CHECK) || 
                                   (coalesce(moj_fcco_balance_2016,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2016,0) > MIN_CHECK) ||
                                   (coalesce(moj_fcco_balance_2016,0) > MIN_CHECK & coalesce(moj_fcco_principle_2016,0) > MIN_CHECK)), 1, 0),
    moj_fcco_17_debtor = ifelse(((coalesce(moj_fcco_balance_2017,0) > MIN_CHECK) || 
                                   (coalesce(moj_fcco_balance_2017,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2017,0) > MIN_CHECK) ||
                                   (coalesce(moj_fcco_balance_2017,0) > MIN_CHECK & coalesce(moj_fcco_principle_2017,0) > MIN_CHECK)), 1, 0),
    moj_fcco_18_debtor = ifelse(((coalesce(moj_fcco_balance_2018,0) > MIN_CHECK) || 
                                   (coalesce(moj_fcco_balance_2018,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2018,0) > MIN_CHECK) ||
                                   (coalesce(moj_fcco_balance_2018,0) > MIN_CHECK & coalesce(moj_fcco_principle_2018,0) > MIN_CHECK)), 1, 0),
    moj_fcco_19_debtor = ifelse(((coalesce(moj_fcco_balance_2019,0) > MIN_CHECK) || 
                                   (coalesce(moj_fcco_balance_2019,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2019,0) > MIN_CHECK) ||
                                   (coalesce(moj_fcco_balance_2019,0) > MIN_CHECK & coalesce(moj_fcco_principle_2019,0) > MIN_CHECK)), 1, 0),
    moj_fcco_20_debtor = ifelse(((coalesce(moj_fcco_balance_2020,0) > MIN_CHECK) || 
                                   (coalesce(moj_fcco_balance_2020,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2020,0) > MIN_CHECK) ||
                                   (coalesce(moj_fcco_balance_2020,0) > MIN_CHECK & coalesce(moj_fcco_principle_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
  
  # IR - Child Support Debtors  ------------------------------------------------------------------------- 
  mutate(
    ir_child_12_debtor = ifelse(((coalesce(ird_pr19_balance_child_2012,0) > MIN_CHECK) || 
                                   (coalesce(ird_pr19_balance_child_2012,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2012,0) > MIN_CHECK) ||
                                   (coalesce(ird_pr19_balance_child_2012,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2012,0) > MIN_CHECK)), 1, 0),
    ir_child_13_debtor = ifelse(((coalesce(ird_pr19_balance_child_2013,0) > MIN_CHECK) || 
                                   (coalesce(ird_pr19_balance_child_2013,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2013,0) > MIN_CHECK) ||
                                   (coalesce(ird_pr19_balance_child_2013,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2013,0) > MIN_CHECK)), 1, 0),
    ir_child_14_debtor = ifelse(((coalesce(ird_pr19_balance_child_2014,0) > MIN_CHECK) || 
                                   (coalesce(ird_pr19_balance_child_2014,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2014,0) > MIN_CHECK) ||
                                   (coalesce(ird_pr19_balance_child_2014,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2014,0) > MIN_CHECK)), 1, 0),
    ir_child_15_debtor = ifelse(((coalesce(ird_pr19_balance_child_2015,0) > MIN_CHECK) || 
                                   (coalesce(ird_pr19_balance_child_2015,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2015,0) > MIN_CHECK) ||
                                   (coalesce(ird_pr19_balance_child_2015,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2015,0) > MIN_CHECK)), 1, 0),
    ir_child_16_debtor = ifelse(((coalesce(ird_pr19_balance_child_2016,0) > MIN_CHECK) || 
                                   (coalesce(ird_pr19_balance_child_2016,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2016,0) > MIN_CHECK) ||
                                   (coalesce(ird_pr19_balance_child_2016,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2016,0) > MIN_CHECK)), 1, 0),
    ir_child_17_debtor = ifelse(((coalesce(ird_pr19_balance_child_2017,0) > MIN_CHECK) || 
                                   (coalesce(ird_pr19_balance_child_2017,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2017,0) > MIN_CHECK) ||
                                   (coalesce(ird_pr19_balance_child_2017,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2017,0) > MIN_CHECK)), 1, 0),
    ir_child_18_debtor = ifelse(((coalesce(ird_pr19_balance_child_2018,0) > MIN_CHECK) || 
                                   (coalesce(ird_pr19_balance_child_2018,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2018,0) > MIN_CHECK) ||
                                   (coalesce(ird_pr19_balance_child_2018,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2018,0) > MIN_CHECK)), 1, 0),
    ir_child_19_debtor = ifelse(((coalesce(ird_ps18_balance_child_2019,0) > MIN_CHECK) || 
                                   (coalesce(ird_ps18_balance_child_2019,0) > MIN_CHECK & coalesce(ird_ps18_repayment_child_2019,0) > MIN_CHECK) ||
                                   (coalesce(ird_ps18_balance_child_2019,0) > MIN_CHECK & coalesce(ird_ps18_principle_child_2019,0) > MIN_CHECK)), 1, 0),
    ir_child_20_debtor = ifelse(((coalesce(ird_ps18_balance_child_2020,0) > MIN_CHECK) || 
                                   (coalesce(ird_ps18_balance_child_2020,0) > MIN_CHECK & coalesce(ird_ps18_repayment_child_2020,0) > MIN_CHECK) ||
                                   (coalesce(ird_ps18_balance_child_2020,0) > MIN_CHECK & coalesce(ird_ps18_principle_child_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
  
  # IR - Income Tax Debtors -------------------------------------------------------------------------  
  mutate(
    ir_income_12_debtor = ifelse(((coalesce(ird_pr19_balance_income_2012,0) > MIN_CHECK) || 
                                    (coalesce(ird_pr19_balance_income_2012,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2012,0) > MIN_CHECK) ||
                                    (coalesce(ird_pr19_balance_income_2012,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2012,0) > MIN_CHECK)), 1, 0),
    ir_income_13_debtor = ifelse(((coalesce(ird_pr19_balance_income_2013,0) > MIN_CHECK) || 
                                    (coalesce(ird_pr19_balance_income_2013,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2013,0) > MIN_CHECK) ||
                                    (coalesce(ird_pr19_balance_income_2013,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2013,0) > MIN_CHECK)), 1, 0),
    ir_income_14_debtor = ifelse(((coalesce(ird_pr19_balance_income_2014,0) > MIN_CHECK) || 
                                    (coalesce(ird_pr19_balance_income_2014,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2014,0) > MIN_CHECK) ||
                                    (coalesce(ird_pr19_balance_income_2014,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2014,0) > MIN_CHECK)), 1, 0),
    ir_income_15_debtor = ifelse(((coalesce(ird_pr19_balance_income_2015,0) > MIN_CHECK) || 
                                    (coalesce(ird_pr19_balance_income_2015,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2015,0) > MIN_CHECK) ||
                                    (coalesce(ird_pr19_balance_income_2015,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2015,0) > MIN_CHECK)), 1, 0),
    ir_income_16_debtor = ifelse(((coalesce(ird_pr19_balance_income_2016,0) > MIN_CHECK) || 
                                    (coalesce(ird_pr19_balance_income_2016,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2016,0) > MIN_CHECK) ||
                                    (coalesce(ird_pr19_balance_income_2016,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2016,0) > MIN_CHECK)), 1, 0),
    ir_income_17_debtor = ifelse(((coalesce(ird_pr19_balance_income_2017,0) > MIN_CHECK) || 
                                    (coalesce(ird_pr19_balance_income_2017,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2017,0) > MIN_CHECK) ||
                                    (coalesce(ird_pr19_balance_income_2017,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2017,0) > MIN_CHECK)), 1, 0),
    ir_income_18_debtor = ifelse(((coalesce(ird_pr19_balance_income_2018,0) > MIN_CHECK) || 
                                    (coalesce(ird_pr19_balance_income_2018,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2018,0) > MIN_CHECK) ||
                                    (coalesce(ird_pr19_balance_income_2018,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2018,0) > MIN_CHECK)), 1, 0),
    ir_income_19_debtor = ifelse(((coalesce(ird_ps18_balance_income_2019,0) > MIN_CHECK) || 
                                    (coalesce(ird_ps18_balance_income_2019,0) > MIN_CHECK & coalesce(ird_ps18_repayment_income_2019,0) > MIN_CHECK) ||
                                    (coalesce(ird_ps18_balance_income_2019,0) > MIN_CHECK & coalesce(ird_ps18_principle_income_2019,0) > MIN_CHECK)), 1, 0),
    ir_income_20_debtor = ifelse(((coalesce(ird_ps18_balance_income_2020,0) > MIN_CHECK) || 
                                    (coalesce(ird_ps18_balance_income_2020,0) > MIN_CHECK & coalesce(ird_ps18_repayment_income_2020,0) > MIN_CHECK) ||
                                    (coalesce(ird_ps18_balance_income_2020,0) > MIN_CHECK & coalesce(ird_ps18_principle_income_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
  
  # IR - Overdue Student Loan Debtors -------------------------------------------------------------------------
  mutate(
    ir_student_12_debtor = ifelse(((coalesce(ird_pr19_balance_student_2012,0) > MIN_CHECK) || 
                                     (coalesce(ird_pr19_balance_student_2012,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2012,0) > MIN_CHECK) ||
                                     (coalesce(ird_pr19_balance_student_2012,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2012,0) > MIN_CHECK)), 1, 0),
    ir_student_13_debtor = ifelse(((coalesce(ird_pr19_balance_student_2013,0) > MIN_CHECK) || 
                                     (coalesce(ird_pr19_balance_student_2013,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2013,0) > MIN_CHECK) ||
                                     (coalesce(ird_pr19_balance_student_2013,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2013,0) > MIN_CHECK)), 1, 0),
    ir_student_14_debtor = ifelse(((coalesce(ird_pr19_balance_student_2014,0) > MIN_CHECK) || 
                                     (coalesce(ird_pr19_balance_student_2014,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2014,0) > MIN_CHECK) ||
                                     (coalesce(ird_pr19_balance_student_2014,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2014,0) > MIN_CHECK)), 1, 0),
    ir_student_15_debtor = ifelse(((coalesce(ird_pr19_balance_student_2015,0) > MIN_CHECK) || 
                                     (coalesce(ird_pr19_balance_student_2015,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2015,0) > MIN_CHECK) ||
                                     (coalesce(ird_pr19_balance_student_2015,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2015,0) > MIN_CHECK)), 1, 0),
    ir_student_16_debtor = ifelse(((coalesce(ird_pr19_balance_student_2016,0) > MIN_CHECK) || 
                                     (coalesce(ird_pr19_balance_student_2016,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2016,0) > MIN_CHECK) ||
                                     (coalesce(ird_pr19_balance_student_2016,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2016,0) > MIN_CHECK)), 1, 0),
    ir_student_17_debtor = ifelse(((coalesce(ird_pr19_balance_student_2017,0) > MIN_CHECK) || 
                                     (coalesce(ird_pr19_balance_student_2017,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2017,0) > MIN_CHECK) ||
                                     (coalesce(ird_pr19_balance_student_2017,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2017,0) > MIN_CHECK)), 1, 0),
    ir_student_18_debtor = ifelse(((coalesce(ird_pr19_balance_student_2018,0) > MIN_CHECK) || 
                                     (coalesce(ird_pr19_balance_student_2018,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2018,0) > MIN_CHECK) ||
                                     (coalesce(ird_pr19_balance_student_2018,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2018,0) > MIN_CHECK)), 1, 0),
    # ir_student_19_debtor = ifelse(((coalesce(ird_ps18_balance_student_2019,0) > MIN_CHECK) || 
    #                                  (coalesce(ird_ps18_balance_student_2019,0) > MIN_CHECK & coalesce(ird_ps18_repayment_student_2019,0) > MIN_CHECK) ||
    #                                  (coalesce(ird_ps18_balance_student_2019,0) > MIN_CHECK & coalesce(ird_ps18_principle_student_2019,0) > MIN_CHECK)), 1, 0),
    ir_student_20_debtor = ifelse(((coalesce(ird_ps18_balance_student_2020,0) > MIN_CHECK) || 
                                     (coalesce(ird_ps18_balance_student_2020,0) > MIN_CHECK & coalesce(ird_ps18_repayment_student_2020,0) > MIN_CHECK) ||
                                     (coalesce(ird_ps18_balance_student_2020,0) > MIN_CHECK & coalesce(ird_ps18_principle_student_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
  
  # IR - Working For Families Debtors -------------------------------------------------------------------------
  mutate(
    ir_wff_12_debtor = ifelse(((coalesce(ird_pr19_balance_wff_2012,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_wff_2012,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2012,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_wff_2012,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2012,0) > MIN_CHECK)), 1, 0),
    ir_wff_13_debtor = ifelse(((coalesce(ird_pr19_balance_wff_2013,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_wff_2013,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2013,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_wff_2013,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2013,0) > MIN_CHECK)), 1, 0),
    ir_wff_14_debtor = ifelse(((coalesce(ird_pr19_balance_wff_2014,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_wff_2014,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2014,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_wff_2014,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2014,0) > MIN_CHECK)), 1, 0),
    ir_wff_15_debtor = ifelse(((coalesce(ird_pr19_balance_wff_2015,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_wff_2015,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2015,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_wff_2015,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2015,0) > MIN_CHECK)), 1, 0),
    ir_wff_16_debtor = ifelse(((coalesce(ird_pr19_balance_wff_2016,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_wff_2016,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2016,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_wff_2016,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2016,0) > MIN_CHECK)), 1, 0),
    ir_wff_17_debtor = ifelse(((coalesce(ird_pr19_balance_wff_2017,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_wff_2017,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2017,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_wff_2017,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2017,0) > MIN_CHECK)), 1, 0),
    ir_wff_18_debtor = ifelse(((coalesce(ird_pr19_balance_wff_2018,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_wff_2018,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2018,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_wff_2018,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2018,0) > MIN_CHECK)), 1, 0),
    ir_wff_19_debtor = ifelse(((coalesce(ird_ps18_balance_wff_2019,0) > MIN_CHECK) || 
                                 (coalesce(ird_ps18_balance_wff_2019,0) > MIN_CHECK & coalesce(ird_ps18_repayment_wff_2019,0) > MIN_CHECK) ||
                                 (coalesce(ird_ps18_balance_wff_2019,0) > MIN_CHECK & coalesce(ird_ps18_principle_wff_2019,0) > MIN_CHECK)), 1, 0),
    ir_wff_20_debtor = ifelse(((coalesce(ird_ps18_balance_wff_2020,0) > MIN_CHECK) || 
                                 (coalesce(ird_ps18_balance_wff_2020,0) > MIN_CHECK & coalesce(ird_ps18_repayment_wff_2020,0) > MIN_CHECK) ||
                                 (coalesce(ird_ps18_balance_wff_2020,0) > MIN_CHECK & coalesce(ird_ps18_principle_wff_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
  
  # IR - Other Debtors -------------------------------------------------------------------------
  mutate(
    ir_oth_12_debtor = ifelse(((coalesce(ird_pr19_balance_oth_2012,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_oth_2012,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2012,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_oth_2012,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2012,0) > MIN_CHECK)), 1, 0),
    ir_oth_13_debtor = ifelse(((coalesce(ird_pr19_balance_oth_2013,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_oth_2013,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2013,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_oth_2013,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2013,0) > MIN_CHECK)), 1, 0),
    ir_oth_14_debtor = ifelse(((coalesce(ird_pr19_balance_oth_2014,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_oth_2014,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2014,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_oth_2014,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2014,0) > MIN_CHECK)), 1, 0),
    ir_oth_15_debtor = ifelse(((coalesce(ird_pr19_balance_oth_2015,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_oth_2015,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2015,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_oth_2015,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2015,0) > MIN_CHECK)), 1, 0),
    ir_oth_16_debtor = ifelse(((coalesce(ird_pr19_balance_oth_2016,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_oth_2016,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2016,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_oth_2016,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2016,0) > MIN_CHECK)), 1, 0),
    ir_oth_17_debtor = ifelse(((coalesce(ird_pr19_balance_oth_2017,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_oth_2017,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2017,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_oth_2017,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2017,0) > MIN_CHECK)), 1, 0),
    ir_oth_18_debtor = ifelse(((coalesce(ird_pr19_balance_oth_2018,0) > MIN_CHECK) || 
                                 (coalesce(ird_pr19_balance_oth_2018,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2018,0) > MIN_CHECK) ||
                                 (coalesce(ird_pr19_balance_oth_2018,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2018,0) > MIN_CHECK)), 1, 0),
    ir_oth_19_debtor = ifelse(((coalesce(ird_ps18_balance_oth_2019,0) > MIN_CHECK) || 
                                 (coalesce(ird_ps18_balance_oth_2019,0) > MIN_CHECK & coalesce(ird_ps18_repayment_oth_2019,0) > MIN_CHECK) ||
                                 (coalesce(ird_ps18_balance_oth_2019,0) > MIN_CHECK & coalesce(ird_ps18_principle_oth_2019,0) > MIN_CHECK)), 1, 0),
    ir_oth_20_debtor = ifelse(((coalesce(ird_ps18_balance_oth_2020,0) > MIN_CHECK) || 
                                 (coalesce(ird_ps18_balance_oth_2020,0) > MIN_CHECK & coalesce(ird_ps18_repayment_oth_2020,0) > MIN_CHECK) ||
                                 (coalesce(ird_ps18_balance_oth_2020,0) > MIN_CHECK & coalesce(ird_ps18_principle_oth_2020,0) > MIN_CHECK)), 1, 0)
  )%>%
...
## Exclude fully repaid debtors -------------------------------------------------------------------------
working_table = working_table %>%
  # MSD repaid ------------------------------------------------------------------------------
  mutate(
    msd_repaid_2012 = ifelse(((coalesce(msd_balance_2012,0) > MIN_CHECK) || 
                                (coalesce(msd_balance_2012,0) > MIN_CHECK & coalesce(msd_repaid_2012,0) > MIN_CHECK) ||
                                (coalesce(msd_balance_2012,0) > MIN_CHECK & coalesce(msd_principle_2012,0) > MIN_CHECK)), msd_repaid_2012, 0),
    
    msd_repaid_2013 = ifelse(((coalesce(msd_balance_2013,0) > MIN_CHECK) || 
                                (coalesce(msd_balance_2013,0) > MIN_CHECK & coalesce(msd_repaid_2013,0) > MIN_CHECK) ||
                                (coalesce(msd_balance_2013,0) > MIN_CHECK & coalesce(msd_principle_2013,0) > MIN_CHECK)), msd_repaid_2013, 0),
    
    msd_repaid_2014 = ifelse(((coalesce(msd_balance_2014,0) > MIN_CHECK) || 
                                (coalesce(msd_balance_2014,0) > MIN_CHECK & coalesce(msd_repaid_2014,0) > MIN_CHECK) ||
                                (coalesce(msd_balance_2014,0) > MIN_CHECK & coalesce(msd_principle_2014,0) > MIN_CHECK)), msd_repaid_2014, 0),
    
    msd_repaid_2015 = ifelse(((coalesce(msd_balance_2015,0) > MIN_CHECK) || 
                                (coalesce(msd_balance_2015,0) > MIN_CHECK & coalesce(msd_repaid_2015,0) > MIN_CHECK) ||
                                (coalesce(msd_balance_2015,0) > MIN_CHECK & coalesce(msd_principle_2015,0) > MIN_CHECK)), msd_repaid_2015, 0),
    
    msd_repaid_2016 = ifelse(((coalesce(msd_balance_2016,0) > MIN_CHECK) || 
                                (coalesce(msd_balance_2016,0) > MIN_CHECK & coalesce(msd_repaid_2016,0) > MIN_CHECK) ||
                                (coalesce(msd_balance_2016,0) > MIN_CHECK & coalesce(msd_principle_2016,0) > MIN_CHECK)), msd_repaid_2016, 0),
    
    msd_repaid_2017 = ifelse(((coalesce(msd_balance_2017,0) > MIN_CHECK) ||
                                (coalesce(msd_balance_2017,0) > MIN_CHECK & coalesce(msd_repaid_2017,0) > MIN_CHECK) ||
                                (coalesce(msd_balance_2017,0) > MIN_CHECK & coalesce(msd_principle_2017,0) > MIN_CHECK)), msd_repaid_2017, 0),
    
    msd_repaid_2018 = ifelse(((coalesce(msd_balance_2018,0) > MIN_CHECK) || 
                                (coalesce(msd_balance_2018,0) > MIN_CHECK & coalesce(msd_repaid_2018,0) > MIN_CHECK) ||
                                (coalesce(msd_balance_2018,0) > MIN_CHECK & coalesce(msd_principle_2018,0) > MIN_CHECK)), msd_repaid_2018, 0),
    
    msd_repaid_2019 = ifelse(((coalesce(msd_balance_2019,0) > MIN_CHECK) || 
                                (coalesce(msd_balance_2019,0) > MIN_CHECK & coalesce(msd_repaid_2019,0) > MIN_CHECK) ||
                                (coalesce(msd_balance_2019,0) > MIN_CHECK & coalesce(msd_principle_2019,0) > MIN_CHECK)), msd_repaid_2019, 0),
    
    msd_repaid_2020 = ifelse(((coalesce(msd_balance_2020,0) > MIN_CHECK) || 
                                (coalesce(msd_balance_2020,0) > MIN_CHECK & coalesce(msd_repaid_2020,0) > MIN_CHECK) ||
                                (coalesce(msd_balance_2020,0) > MIN_CHECK & coalesce(msd_principle_2020,0) > MIN_CHECK)), msd_repaid_2020, 0)
  ) %>%
    
  # MOJ Fine repaid -------------------------------------------------------------------------
  mutate(
    moj_fine_repaid_2012 = ifelse(((coalesce(moj_fine_balance_2012,0) > MIN_CHECK) || 
                                     (coalesce(moj_fine_balance_2012,0) > MIN_CHECK & coalesce(moj_fine_repaid_2012,0) > MIN_CHECK) ||
                                     (coalesce(moj_fine_balance_2012,0) > MIN_CHECK & coalesce(moj_fine_principle_2012,0) > MIN_CHECK)), moj_fine_repaid_2012, 0),
    moj_fine_repaid_2013 = ifelse(((coalesce(moj_fine_balance_2013,0) > MIN_CHECK) || 
                                     (coalesce(moj_fine_balance_2013,0) > MIN_CHECK & coalesce(moj_fine_repaid_2013,0) > MIN_CHECK) ||
                                     (coalesce(moj_fine_balance_2013,0) > MIN_CHECK & coalesce(moj_fine_principle_2013,0) > MIN_CHECK)), moj_fine_repaid_2013, 0),
    moj_fine_repaid_2014 = ifelse(((coalesce(moj_fine_balance_2014,0) > MIN_CHECK) || 
                                     (coalesce(moj_fine_balance_2014,0) > MIN_CHECK & coalesce(moj_fine_repaid_2014,0) > MIN_CHECK) ||
                                     (coalesce(moj_fine_balance_2014,0) > MIN_CHECK & coalesce(moj_fine_principle_2014,0) > MIN_CHECK)), moj_fine_repaid_2014, 0),
    moj_fine_repaid_2015 = ifelse(((coalesce(moj_fine_balance_2015,0) > MIN_CHECK) || 
                                     (coalesce(moj_fine_balance_2015,0) > MIN_CHECK & coalesce(moj_fine_repaid_2015,0) > MIN_CHECK) ||
                                     (coalesce(moj_fine_balance_2015,0) > MIN_CHECK & coalesce(moj_fine_principle_2015,0) > MIN_CHECK)), moj_fine_repaid_2015, 0),
    moj_fine_repaid_2016 = ifelse(((coalesce(moj_fine_balance_2016,0) > MIN_CHECK) || 
                                     (coalesce(moj_fine_balance_2016,0) > MIN_CHECK & coalesce(moj_fine_repaid_2016,0) > MIN_CHECK) ||
                                     (coalesce(moj_fine_balance_2016,0) > MIN_CHECK & coalesce(moj_fine_principle_2016,0) > MIN_CHECK)), moj_fine_repaid_2016, 0),
    moj_fine_repaid_2017 = ifelse(((coalesce(moj_fine_balance_2017,0) > MIN_CHECK) || 
                                     (coalesce(moj_fine_balance_2017,0) > MIN_CHECK & coalesce(moj_fine_repaid_2017,0) > MIN_CHECK) ||
                                     (coalesce(moj_fine_balance_2017,0) > MIN_CHECK & coalesce(moj_fine_principle_2017,0) > MIN_CHECK)), moj_fine_repaid_2017, 0),
    moj_fine_repaid_2018 = ifelse(((coalesce(moj_fine_balance_2018,0) > MIN_CHECK) || 
                                     (coalesce(moj_fine_balance_2018,0) > MIN_CHECK & coalesce(moj_fine_repaid_2018,0) > MIN_CHECK) ||
                                     (coalesce(moj_fine_balance_2018,0) > MIN_CHECK & coalesce(moj_fine_principle_2018,0) > MIN_CHECK)), moj_fine_repaid_2018, 0),
    moj_fine_repaid_2019 = ifelse(((coalesce(moj_fine_balance_2019,0) > MIN_CHECK) || 
                                     (coalesce(moj_fine_balance_2019,0) > MIN_CHECK & coalesce(moj_fine_repaid_2019,0) > MIN_CHECK) ||
                                     (coalesce(moj_fine_balance_2019,0) > MIN_CHECK & coalesce(moj_fine_principle_2019,0) > MIN_CHECK)), moj_fine_repaid_2019, 0),
    moj_fine_repaid_2020 = ifelse(((coalesce(moj_fine_balance_2020,0) > MIN_CHECK) || 
                                     (coalesce(moj_fine_balance_2020,0) > MIN_CHECK & coalesce(moj_fine_repaid_2020,0) > MIN_CHECK) ||
                                     (coalesce(moj_fine_balance_2020,0) > MIN_CHECK & coalesce(moj_fine_principle_2020,0) > MIN_CHECK)), moj_fine_repaid_2020, 0)
  ) %>%
    
  # MOJ FCCO repaid -------------------------------------------------------------------------
  mutate(
    moj_fcco_repaid_2014 = ifelse(((coalesce(moj_fcco_balance_2014,0) > MIN_CHECK) || 
                                     (coalesce(moj_fcco_balance_2014,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2014,0) > MIN_CHECK) ||
                                     (coalesce(moj_fcco_balance_2014,0) > MIN_CHECK & coalesce(moj_fcco_principle_2014,0) > MIN_CHECK)), 1, 0),
    moj_fcco_repaid_2015 = ifelse(((coalesce(moj_fcco_balance_2015,0) > MIN_CHECK) || 
                                     (coalesce(moj_fcco_balance_2015,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2015,0) > MIN_CHECK) ||
                                     (coalesce(moj_fcco_balance_2015,0) > MIN_CHECK & coalesce(moj_fcco_principle_2015,0) > MIN_CHECK)), 1, 0),
    moj_fcco_repaid_2016 = ifelse(((coalesce(moj_fcco_balance_2016,0) > MIN_CHECK) || 
                                     (coalesce(moj_fcco_balance_2016,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2016,0) > MIN_CHECK) ||
                                     (coalesce(moj_fcco_balance_2016,0) > MIN_CHECK & coalesce(moj_fcco_principle_2016,0) > MIN_CHECK)), 1, 0),
    moj_fcco_repaid_2017 = ifelse(((coalesce(moj_fcco_balance_2017,0) > MIN_CHECK) || 
                                     (coalesce(moj_fcco_balance_2017,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2017,0) > MIN_CHECK) ||
                                     (coalesce(moj_fcco_balance_2017,0) > MIN_CHECK & coalesce(moj_fcco_principle_2017,0) > MIN_CHECK)), 1, 0),
    moj_fcco_repaid_2018 = ifelse(((coalesce(moj_fcco_balance_2018,0) > MIN_CHECK) || 
                                     (coalesce(moj_fcco_balance_2018,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2018,0) > MIN_CHECK) ||
                                     (coalesce(moj_fcco_balance_2018,0) > MIN_CHECK & coalesce(moj_fcco_principle_2018,0) > MIN_CHECK)), 1, 0),
    moj_fcco_repaid_2019 = ifelse(((coalesce(moj_fcco_balance_2019,0) > MIN_CHECK) || 
                                     (coalesce(moj_fcco_balance_2019,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2019,0) > MIN_CHECK) ||
                                     (coalesce(moj_fcco_balance_2019,0) > MIN_CHECK & coalesce(moj_fcco_principle_2019,0) > MIN_CHECK)), 1, 0),
    moj_fcco_repaid_2020 = ifelse(((coalesce(moj_fcco_balance_2020,0) > MIN_CHECK) || 
                                     (coalesce(moj_fcco_balance_2020,0) > MIN_CHECK & coalesce(moj_fcco_repaid_2020,0) > MIN_CHECK) ||
                                     (coalesce(moj_fcco_balance_2020,0) > MIN_CHECK & coalesce(moj_fcco_principle_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
    
  # IR - Child Support repaid  ------------------------------------------------------------------------- 
  mutate(
    ird_pr19_repaid_child_2012 = ifelse(((coalesce(ird_pr19_balance_child_2012,0) > MIN_CHECK) || 
                                           (coalesce(ird_pr19_balance_child_2012,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2012,0) > MIN_CHECK) ||
                                           (coalesce(ird_pr19_balance_child_2012,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2012,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_child_2013 = ifelse(((coalesce(ird_pr19_balance_child_2013,0) > MIN_CHECK) || 
                                           (coalesce(ird_pr19_balance_child_2013,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2013,0) > MIN_CHECK) ||
                                           (coalesce(ird_pr19_balance_child_2013,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2013,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_child_2014 = ifelse(((coalesce(ird_pr19_balance_child_2014,0) > MIN_CHECK) || 
                                           (coalesce(ird_pr19_balance_child_2014,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2014,0) > MIN_CHECK) ||
                                           (coalesce(ird_pr19_balance_child_2014,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2014,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_child_2015 = ifelse(((coalesce(ird_pr19_balance_child_2015,0) > MIN_CHECK) || 
                                           (coalesce(ird_pr19_balance_child_2015,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2015,0) > MIN_CHECK) ||
                                           (coalesce(ird_pr19_balance_child_2015,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2015,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_child_2016 = ifelse(((coalesce(ird_pr19_balance_child_2016,0) > MIN_CHECK) || 
                                           (coalesce(ird_pr19_balance_child_2016,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2016,0) > MIN_CHECK) ||
                                           (coalesce(ird_pr19_balance_child_2016,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2016,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_child_2017 = ifelse(((coalesce(ird_pr19_balance_child_2017,0) > MIN_CHECK) || 
                                           (coalesce(ird_pr19_balance_child_2017,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2017,0) > MIN_CHECK) ||
                                           (coalesce(ird_pr19_balance_child_2017,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2017,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_child_2018 = ifelse(((coalesce(ird_pr19_balance_child_2018,0) > MIN_CHECK) || 
                                           (coalesce(ird_pr19_balance_child_2018,0) > MIN_CHECK & coalesce(ird_pr19_repaid_child_2018,0) > MIN_CHECK) ||
                                           (coalesce(ird_pr19_balance_child_2018,0) > MIN_CHECK & coalesce(ird_pr19_principle_child_2018,0) > MIN_CHECK)), 1, 0),
    ird_ps18_repaid_child_2019 = ifelse(((coalesce(ird_ps18_balance_child_2019,0) > MIN_CHECK) || 
                                           (coalesce(ird_ps18_balance_child_2019,0) > MIN_CHECK & coalesce(ird_ps18_repayment_child_2019,0) > MIN_CHECK) ||
                                           (coalesce(ird_ps18_balance_child_2019,0) > MIN_CHECK & coalesce(ird_ps18_principle_child_2019,0) > MIN_CHECK)), 1, 0),
    ird_ps18_repaid_child_2020 = ifelse(((coalesce(ird_ps18_balance_child_2020,0) > MIN_CHECK) || 
                                           (coalesce(ird_ps18_balance_child_2020,0) > MIN_CHECK & coalesce(ird_ps18_repayment_child_2020,0) > MIN_CHECK) ||
                                           (coalesce(ird_ps18_balance_child_2020,0) > MIN_CHECK & coalesce(ird_ps18_principle_child_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
    
  # IR - Income Tax repaid -------------------------------------------------------------------------  
  mutate(
    ird_pr19_repaid_income_2012 = ifelse(((coalesce(ird_pr19_balance_income_2012,0) > MIN_CHECK) || 
                                            (coalesce(ird_pr19_balance_income_2012,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2012,0) > MIN_CHECK) ||
                                            (coalesce(ird_pr19_balance_income_2012,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2012,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_income_2013 = ifelse(((coalesce(ird_pr19_balance_income_2013,0) > MIN_CHECK) || 
                                            (coalesce(ird_pr19_balance_income_2013,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2013,0) > MIN_CHECK) ||
                                            (coalesce(ird_pr19_balance_income_2013,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2013,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_income_2014 = ifelse(((coalesce(ird_pr19_balance_income_2014,0) > MIN_CHECK) || 
                                            (coalesce(ird_pr19_balance_income_2014,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2014,0) > MIN_CHECK) ||
                                            (coalesce(ird_pr19_balance_income_2014,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2014,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_income_2015 = ifelse(((coalesce(ird_pr19_balance_income_2015,0) > MIN_CHECK) || 
                                            (coalesce(ird_pr19_balance_income_2015,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2015,0) > MIN_CHECK) ||
                                            (coalesce(ird_pr19_balance_income_2015,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2015,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_income_2016 = ifelse(((coalesce(ird_pr19_balance_income_2016,0) > MIN_CHECK) || 
                                            (coalesce(ird_pr19_balance_income_2016,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2016,0) > MIN_CHECK) ||
                                            (coalesce(ird_pr19_balance_income_2016,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2016,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_income_2017 = ifelse(((coalesce(ird_pr19_balance_income_2017,0) > MIN_CHECK) || 
                                            (coalesce(ird_pr19_balance_income_2017,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2017,0) > MIN_CHECK) ||
                                            (coalesce(ird_pr19_balance_income_2017,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2017,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_income_2018 = ifelse(((coalesce(ird_pr19_balance_income_2018,0) > MIN_CHECK) || 
                                            (coalesce(ird_pr19_balance_income_2018,0) > MIN_CHECK & coalesce(ird_pr19_repaid_income_2018,0) > MIN_CHECK) ||
                                            (coalesce(ird_pr19_balance_income_2018,0) > MIN_CHECK & coalesce(ird_pr19_principle_income_2018,0) > MIN_CHECK)), 1, 0),
    ird_ps18_repaid_income_2019 = ifelse(((coalesce(ird_ps18_balance_income_2019,0) > MIN_CHECK) || 
                                            (coalesce(ird_ps18_balance_income_2019,0) > MIN_CHECK & coalesce(ird_ps18_repayment_income_2019,0) > MIN_CHECK) ||
                                            (coalesce(ird_ps18_balance_income_2019,0) > MIN_CHECK & coalesce(ird_ps18_principle_income_2019,0) > MIN_CHECK)), 1, 0),
    ird_ps18_repaid_income_2020 = ifelse(((coalesce(ird_ps18_balance_income_2020,0) > MIN_CHECK) || 
                                            (coalesce(ird_ps18_balance_income_2020,0) > MIN_CHECK & coalesce(ird_ps18_repayment_income_2020,0) > MIN_CHECK) ||
                                            (coalesce(ird_ps18_balance_income_2020,0) > MIN_CHECK & coalesce(ird_ps18_principle_income_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
    
  # IR - Overdue Student Loan repaid -------------------------------------------------------------------------
  mutate(
    ird_pr19_repaid_student_2012 = ifelse(((coalesce(ird_pr19_balance_student_2012,0) > MIN_CHECK) || 
                                             (coalesce(ird_pr19_balance_student_2012,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2012,0) > MIN_CHECK) ||
                                             (coalesce(ird_pr19_balance_student_2012,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2012,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_student_2013 = ifelse(((coalesce(ird_pr19_balance_student_2013,0) > MIN_CHECK) || 
                                             (coalesce(ird_pr19_balance_student_2013,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2013,0) > MIN_CHECK) ||
                                             (coalesce(ird_pr19_balance_student_2013,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2013,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_student_2014 = ifelse(((coalesce(ird_pr19_balance_student_2014,0) > MIN_CHECK) || 
                                             (coalesce(ird_pr19_balance_student_2014,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2014,0) > MIN_CHECK) ||
                                             (coalesce(ird_pr19_balance_student_2014,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2014,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_student_2015 = ifelse(((coalesce(ird_pr19_balance_student_2015,0) > MIN_CHECK) || 
                                             (coalesce(ird_pr19_balance_student_2015,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2015,0) > MIN_CHECK) ||
                                             (coalesce(ird_pr19_balance_student_2015,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2015,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_student_2016 = ifelse(((coalesce(ird_pr19_balance_student_2016,0) > MIN_CHECK) || 
                                             (coalesce(ird_pr19_balance_student_2016,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2016,0) > MIN_CHECK) ||
                                             (coalesce(ird_pr19_balance_student_2016,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2016,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_student_2017 = ifelse(((coalesce(ird_pr19_balance_student_2017,0) > MIN_CHECK) || 
                                             (coalesce(ird_pr19_balance_student_2017,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2017,0) > MIN_CHECK) ||
                                             (coalesce(ird_pr19_balance_student_2017,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2017,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_student_2018 = ifelse(((coalesce(ird_pr19_balance_student_2018,0) > MIN_CHECK) || 
                                             (coalesce(ird_pr19_balance_student_2018,0) > MIN_CHECK & coalesce(ird_pr19_repaid_student_2018,0) > MIN_CHECK) ||
                                             (coalesce(ird_pr19_balance_student_2018,0) > MIN_CHECK & coalesce(ird_pr19_principle_student_2018,0) > MIN_CHECK)), 1, 0),
    # ird_pr19_repaid_student_2019 = ifelse(((coalesce(ird_ps18_balance_student_2019,0) > MIN_CHECK) || 
    #                                          (coalesce(ird_ps18_balance_student_2019,0) > MIN_CHECK & coalesce(ird_ps18_repayment_student_2019,0) > MIN_CHECK) ||
    #                                          (coalesce(ird_ps18_balance_student_2019,0) > MIN_CHECK & coalesce(ird_ps18_principle_student_2019,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_student_2020 = ifelse(((coalesce(ird_ps18_balance_student_2020,0) > MIN_CHECK) || 
                                             (coalesce(ird_ps18_balance_student_2020,0) > MIN_CHECK & coalesce(ird_ps18_repayment_student_2020,0) > MIN_CHECK) ||
                                             (coalesce(ird_ps18_balance_student_2020,0) > MIN_CHECK & coalesce(ird_ps18_principle_student_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
    
  # IR - Working For Families repaid -------------------------------------------------------------------------
  mutate(
    ird_pr19_repaid_wff_2012 = ifelse(((coalesce(ird_pr19_balance_wff_2012,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_wff_2012,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2012,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_wff_2012,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2012,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_wff_2013 = ifelse(((coalesce(ird_pr19_balance_wff_2013,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_wff_2013,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2013,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_wff_2013,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2013,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_wff_2014 = ifelse(((coalesce(ird_pr19_balance_wff_2014,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_wff_2014,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2014,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_wff_2014,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2014,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_wff_2015 = ifelse(((coalesce(ird_pr19_balance_wff_2015,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_wff_2015,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2015,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_wff_2015,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2015,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_wff_2016 = ifelse(((coalesce(ird_pr19_balance_wff_2016,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_wff_2016,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2016,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_wff_2016,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2016,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_wff_2017 = ifelse(((coalesce(ird_pr19_balance_wff_2017,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_wff_2017,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2017,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_wff_2017,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2017,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_wff_2018 = ifelse(((coalesce(ird_pr19_balance_wff_2018,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_wff_2018,0) > MIN_CHECK & coalesce(ird_pr19_repaid_wff_2018,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_wff_2018,0) > MIN_CHECK & coalesce(ird_pr19_principle_wff_2018,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_wff_2019 = ifelse(((coalesce(ird_ps18_balance_wff_2019,0) > MIN_CHECK) || 
                                         (coalesce(ird_ps18_balance_wff_2019,0) > MIN_CHECK & coalesce(ird_ps18_repayment_wff_2019,0) > MIN_CHECK) ||
                                         (coalesce(ird_ps18_balance_wff_2019,0) > MIN_CHECK & coalesce(ird_ps18_principle_wff_2019,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_wff_2020 = ifelse(((coalesce(ird_ps18_balance_wff_2020,0) > MIN_CHECK) || 
                                         (coalesce(ird_ps18_balance_wff_2020,0) > MIN_CHECK & coalesce(ird_ps18_repayment_wff_2020,0) > MIN_CHECK) ||
                                         (coalesce(ird_ps18_balance_wff_2020,0) > MIN_CHECK & coalesce(ird_ps18_principle_wff_2020,0) > MIN_CHECK)), 1, 0)
  ) %>%
  ...
  # IR - Other repaid -------------------------------------------------------------------------
  mutate(
    ird_pr19_repaid_oth_2012 = ifelse(((coalesce(ird_pr19_balance_oth_2012,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_oth_2012,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2012,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_oth_2012,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2012,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_oth_2013 = ifelse(((coalesce(ird_pr19_balance_oth_2013,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_oth_2013,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2013,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_oth_2013,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2013,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_oth_2014 = ifelse(((coalesce(ird_pr19_balance_oth_2014,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_oth_2014,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2014,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_oth_2014,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2014,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_oth_2015 = ifelse(((coalesce(ird_pr19_balance_oth_2015,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_oth_2015,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2015,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_oth_2015,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2015,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_oth_2016 = ifelse(((coalesce(ird_pr19_balance_oth_2016,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_oth_2016,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2016,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_oth_2016,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2016,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_oth_2017 = ifelse(((coalesce(ird_pr19_balance_oth_2017,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_oth_2017,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2017,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_oth_2017,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2017,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_oth_2018 = ifelse(((coalesce(ird_pr19_balance_oth_2018,0) > MIN_CHECK) || 
                                         (coalesce(ird_pr19_balance_oth_2018,0) > MIN_CHECK & coalesce(ird_pr19_repaid_oth_2018,0) > MIN_CHECK) ||
                                         (coalesce(ird_pr19_balance_oth_2018,0) > MIN_CHECK & coalesce(ird_pr19_principle_oth_2018,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_oth_2019 = ifelse(((coalesce(ird_ps18_balance_oth_2019,0) > MIN_CHECK) || 
                                         (coalesce(ird_ps18_balance_oth_2019,0) > MIN_CHECK & coalesce(ird_ps18_repayment_oth_2019,0) > MIN_CHECK) ||
                                         (coalesce(ird_ps18_balance_oth_2019,0) > MIN_CHECK & coalesce(ird_ps18_principle_oth_2019,0) > MIN_CHECK)), 1, 0),
    ird_pr19_repaid_oth_2020 = ifelse(((coalesce(ird_ps18_balance_oth_2020,0) > MIN_CHECK) || 
                                         (coalesce(ird_ps18_balance_oth_2020,0) > MIN_CHECK & coalesce(ird_ps18_repayment_oth_2020,0) > MIN_CHECK) ||
                                         (coalesce(ird_ps18_balance_oth_2020,0) > MIN_CHECK & coalesce(ird_ps18_principle_oth_2020,0) > MIN_CHECK)), 1, 0)
  )
## INTERIM SAVE -------------------------------------------------------------------------------------------------------------------
...
working_table = working_table %>%
  ...
  # IR (Income) ----------------------------------------------------------
      mutate(
        ...
        any_ir_income_persistence = ifelse(ir_income_20_debtor == 1 | 
                                             ir_income_19_debtor == 1 | 
                                             ir_income_18_debtor == 1 | 
                                             ir_income_17_debtor == 1 | 
                                             ir_income_16_debtor == 1 | 
  ...
  # IR (Student) ----------------------------------------------------------
      mutate(
        ...
        any_ir_student_persistence = ifelse(ir_student_20_debtor == 1 | 
                                              ir_student_19_debtor == 1 | 
                                              ir_student_18_debtor == 1 | 
                                              ir_student_17_debtor == 1 | 
                                              ir_student_16_debtor == 1 | 
  ...
  # IR (WFF) ----------------------------------------------------------
      mutate(
        ...
        any_ir_wff_persistence = ifelse(ir_wff_20_debtor == 1 | 
                                          ir_wff_19_debtor == 1 | 
                                          ir_wff_18_debtor == 1 | 
                                          ir_wff_17_debtor == 1 | 
                                          ir_wff_16_debtor == 1 | 
  ...
  # IR (Others) ----------------------------------------------------------
      mutate(
        ...
        any_ir_oth_persistence = ifelse(ir_oth_20_debtor == 1 | 
                                          ir_oth_19_debtor == 1 | 
                                          ir_oth_18_debtor == 1 | 
                                          ir_oth_17_debtor == 1 | 
                                          ir_oth_16_debtor == 1 | 
...
## INTERIM SAVE ----------------------------------------------------------------------------------------------------
working_table = write_for_reuse(db_con, SANDPIT, OUR_SCHEMA, INTERIM_TABLE_5, working_table)
## Ratios -----------------------------------------------------------------------------------------------
working_table = working_table %>%
